...
# If element found, print index and return
add $a0, $t0, $0
li $v0, 1  # Load appropriate syscall number for printing integer
syscall
j exit

not_found:
    # output message for element not found
    li $v0, 4  # Load appropriate syscall number for printing string
    la $a0, output_msg1
    syscall
